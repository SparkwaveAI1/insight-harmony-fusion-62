...
import { useOptimizedCreativeCharacters } from '../hooks/useOptimizedCreativeCharacters';
...
const OptimizedCreativeCharacterLibrary = () => {
  ...
  const { 
    ...
    error,
    isFetching 
  } = useOptimizedCreativeCharacters({
  ...
  // Separate user and public characters
  ...
  const handleImageGenerated = useCallback(() => {
    // Refresh handled by React Query automatically
  }, []);
  ...
  // Loading state
  if (authLoading || (isLoading && currentPage === 1)) {
    return (
          ...
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                {authLoading ? 'Loading authentication...' : 'Loading characters...'}
              </p>
            </div>
          </div>
        </Section>
        ...
        {characters.length === 0 ? (
          <Card className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              {searchQuery 
                ? 'Try adjusting your search or go to the next page'
                : user 
...
export default OptimizedCreativeCharacterLibrary;
