...
const CharacterChatModeSelector: React.FC<CharacterChatModeSelectorProps> = ({ selectedMode, onChange }) => {
  return (
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Natural back-and-forth dialogue with authentic character responses
            </p>
          </div>
        </div>
      </div>
...
export default CharacterChatModeSelector;
