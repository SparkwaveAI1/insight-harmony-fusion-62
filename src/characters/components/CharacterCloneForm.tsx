...
import CharacterCloneFormContent from "./CharacterCloneFormContent";
...
const CharacterCloneForm = ({ character }: CharacterCloneFormProps) => {
  ...
  const handleSubmit = async (data: CharacterCloneFormValues) => {
    try {
      ...
      console.log("Submitting character clone with data:", data);
