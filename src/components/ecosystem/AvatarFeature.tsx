    ...
    <div className="container px-4 mx-auto">
      <div className="max-w-5xl mx-auto text-center mb-12">
        <Reveal>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#221F26] font-plasmik">
            Talk to PersonaAI Research Agent
          </h2>
          <p className="text-[#403E43] text-pretty max-w-2xl mx-auto mb-10">
      ...
      <Reveal>
        <div className="flex flex-col items-center justify-center">
          <div className="relative w-full max-w-2xl mx-auto mb-10 aspect-square sm:aspect-video rounded-2xl overflow-hidden shadow-2xl border border-amber-200/50">
            <img 
      ...
      <Reveal delay={200}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <div className="bg-amber-50 backdrop-blur-sm rounded-xl p-6 shadow-md border border-amber-100">
            <h3 className="font-bold text-lg mb-2 text-[#221F26]">Market Insights</h3>
            <p className="text-[#403E43] text-sm">
          ...
          <div className="bg-orange-50 backdrop-blur-sm rounded-xl p-6 shadow-md border border-amber-100">
            <h3 className="font-bold text-lg mb-2 text-[#221F26]">Token Utility</h3>
            <p className="text-[#403E43] text-sm">
          ...
          <div className="bg-amber-50 backdrop-blur-sm rounded-xl p-6 shadow-md border border-amber-100">
            <h3 className="font-bold text-lg mb-2 text-[#221F26]">Research on Demand</h3>
            <p className="text-[#403E43] text-sm">
