...
const PersonaDisplay: React.FC<PersonaDisplayProps> = ({
  ...
  const renderPersonaDetails = (persona: Persona) => {
    ...
    // Custom text for Alina R
    let decisionText = isAlinaR ? 
      "Relies on data visualization tools for complex financial decisions. Balances risk and reward through multi-scenario modeling." :
    ...
    let driverText = isAlinaR ?
      "Motivated by sustainable growth and ethical investing principles. Values work-life integration." :
    ...
    let persuasionText = isAlinaR ?
      "Responds to evidence-based arguments with practical applications. Appreciates detailed analysis." :
    ...
    return (
      <>
        ...
        <div className="mt-3 bg-blue-50/30 p-2 rounded">
          ...
          <p className="text-xs">{decisionText}</p>
        </div>
        ...
        <div className="mt-3 bg-green-50/30 p-2 rounded">
          ...
          <p className="text-xs">{driverText}</p>
        </div>
        ...
        <div className="mt-3 bg-purple-50/30 p-2 rounded">
          ...
          <p className="text-xs">{persuasionText}</p>
        </div>
      </>
    );
  };
