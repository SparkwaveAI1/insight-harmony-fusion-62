...
const CharacterLabDashboard = () => {
  const [activeSection, setActiveSection] = useState('library');
  const location = useLocation();

  // Update active section based on current route
  useEffect(() => {
    if (location.pathname === '/characters/lab/create') {
      setActiveSection('create-lab');
    } else {
      ...
      <main className="flex-grow">
        <div className="flex pt-20">
          ...
          <div className="flex-1 w-full overflow-x-hidden">
            ...
            {/* Show Character Library when on main lab route */}
            {location.pathname === '/characters/lab' ? (
              ...
              <div className="w-full px-4 md:px-8 py-8">
                <Section>
                  <div className="flex flex-col gap-6 mb-8">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm md:text-base text-muted-foreground">Design and experiment with original fictional characters</p>
                      </div>
                    </div>
                  </div>

                  {/* Character Lab Creation Option */}
                  ...
                  <Card className="text-center py-8 md:py-12">
                    ...
                    <h2 className="text-lg md:text-xl font-semibold mb-2">Character Library</h2>
                    <p className="text-sm md:text-base text-muted-foreground mb-6">
                      View and manage all your lab characters
                    </p>
                    <Button asChild>
...
export default CharacterLabDashboard;
