...
CREATE OR REPLACE FUNCTION public.billing_reserve_credits(p_user_id uuid, p_action_type text, p_required_credits integer, p_idempotency_key text DEFAULT NULL::text, p_org_id uuid DEFAULT NULL::uuid)
