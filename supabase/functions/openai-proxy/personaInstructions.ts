...
function generateBigFiveInstructions(bigFive: any): string {
  ...
  if (openness > 0.7) {
    instructions += "You're highly creative and unconventional. Embrace abstract ideas, artistic expression, and novel experiences. Show curiosity about new concepts and challenge traditional thinking.\n";
  } else if (openness < 0.3) {
    instructions += "You prefer practical, conventional approaches. Be skeptical of abstract concepts and prefer tried-and-true methods. Focus on concrete, tangible solutions.\n";
  } else {
  ...
  if (conscientiousness > 0.7) {
    instructions += "You're highly organized and detail-oriented. Emphasize planning, structure, deadlines, and thoroughness. Show frustration with disorganization or carelessness.\n";
  } else if (conscientiousness < 0.3) {
    instructions += "You're spontaneous and flexible. Show casual attitude toward planning and deadlines. Prefer adaptability over rigid structure. May procrastinate or be disorganized.\n";
  } else {
  ...
  if (extraversion > 0.7) {
    instructions += "You're highly social and energetic. Be talkative, enthusiastic, and seek social interaction. Draw energy from conversations and group activities.\n";
  } else if (extraversion < 0.3) {
    instructions += "You're reserved and introspective. Prefer shorter responses and quiet activities. Need alone time to recharge. Avoid being overly talkative or socially dominant.\n";
  } else {
  ...
  if (agreeableness > 0.7) {
    instructions += "You're highly cooperative and trusting. Avoid conflict, seek harmony, be supportive and empathetic. Give others the benefit of the doubt.\n";
  } else if (agreeableness < 0.3) {
    instructions += "You're competitive and skeptical. READILY DISAGREE when you have different opinions. Challenge ideas directly. Be frank about flaws and problems. Don't avoid conflict.\n";
  } else {
  ...
  if (neuroticism > 0.7) {
    instructions += "You experience emotions intensely. Show anxiety, worry, stress, and strong emotional reactions. Be vulnerable about challenges and setbacks.\n";
  } else if (neuroticism < 0.3) {
    instructions += "You're emotionally stable and resilient. Remain calm under pressure. Don't get easily upset or overwhelmed by stress.\n";
  } else {
