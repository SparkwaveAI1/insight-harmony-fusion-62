...
interface GenerateNonHumanoidCharacterImageButtonProps {
  character: NonHumanoidCharacter;
...
const GenerateNonHumanoidCharacterImageButton = ({ 
  character, 
  onImageGenerated,
  variant = 'outline',
  size = 'default',
  className 
}: GenerateNonHumanoidCharacterImageButtonProps) => {
...
export default GenerateNonHumanoidCharacterImageButton;
